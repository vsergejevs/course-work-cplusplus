...
void srt(int V1, int V2) //Mazakie cipari/vertibas uzpeld uz augsu
{
    ...
    if (V1 == SERV && V2 == NAME)
    {
        for (i = 0; i < num_servs; i++) //looping through the num_servs counter
        {
            ...
            cout << "šī ir iterācija numur " << i << endl;
            cout << "min_j vērtība šobrīd ir: " << min_j << endl;
            cout << "smin struktūra šobrīd pieglabā: " << servs[i] << endl;
            ...
            for (j = i + 1; j < num_servs; j++) //TODO: what is happening here
                    ...
                    //ishem minimalnij element
                {
                    ...
                    cout << "servs[j].name ir jābūt priekšā smin.name pēc alfabēta, tāpēc smin tagad ir " << smin << endl;
                }
